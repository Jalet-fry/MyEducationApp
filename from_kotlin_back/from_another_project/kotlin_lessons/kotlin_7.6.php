...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Отличие последовательности от коллекций Iterable</h2><div class="date">Последнее обновление: 04.03.2024</div>
	<div class="socBlock">
...
<style>
	...
	<div class="nav"><p><a href="./7.16.php">Назад</a><a href="./">Содержание</a><a href="./7.7.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
