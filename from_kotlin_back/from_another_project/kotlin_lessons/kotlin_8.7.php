...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Диспетчер корутины</h2><div class="date">Последнее обновление: 11.12.2024</div>
	<div class="socBlock">
...
<style>
	...
	<div class="nav"><p><a href="./8.4.php">Назад</a><a href="./">Содержание</a><a href="./8.5.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
