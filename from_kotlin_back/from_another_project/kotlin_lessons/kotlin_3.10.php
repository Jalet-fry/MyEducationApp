...
<html  lang="ru">
<head>
<title>Kotlin | Замыкания</title>
<meta charset="utf-8" />
<meta name="description" content="Замыкания closure в языке программирования Kotlin, лексическое окружение функции">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Замыкания</h2><div class="date">Последнее обновление: 03.03.2024</div>
	<div class="socBlock">
...
<pre class="brush:kt;">val fn = outer()</pre>
...
<pre class="brush:kt;">{m:Int-&gt; n * m}</pre>
...
<pre class="brush:kt;">val func = multiply(5)</pre>
...
<style>
	...
	<div class="nav"><p><a href="./3.6.php">Назад</a><a href="./">Содержание</a><a href="./4.1.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
