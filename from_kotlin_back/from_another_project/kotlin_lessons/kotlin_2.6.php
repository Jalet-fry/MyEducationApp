...
<html  lang="ru">
<head>
<title>Kotlin | Условная конструкция if...else</title>
<meta charset="utf-8" />
<meta name="description" content="Условные конструкции в языке программирования Kotlin, операторы if..else">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Условная конструкция if...else</h2><div class="date">Последнее обновление: 02.03.2024</div>
	<div class="socBlock">
...
<p>Аналогично можно использовать <b>else if</b>:</p>
<pre class="brush:kt;">
val a = 20
val b = 20
...
<style>
	...
	<div class="nav"><p><a href="./2.5.php">Назад</a><a href="./">Содержание</a><a href="./2.11.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
