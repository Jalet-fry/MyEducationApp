...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Функциональное программирование</h1><h2>Функции и их параметры</h2><div class="date">Последнее обновление: 11.12.2024</div>
	<div class="socBlock">
...
Если функция возвращает какое-либо значение, то после списка параметров через двоеточие можно указать тип возвращаемого значения. И далее в фигурных скобках идет 
тело функции.</p>
<pre class="brush:kt;">
...
<p>Параметры необязательны. Возвращаемый тип можно не указывать, так как Kotlin обычно сам может его вывести на основании тела функции.</p>
...
<code>имя_параметра : тип_параметра</code>. Например, определим функцию, которая просто выводит сообшение на консоль:</p>
<pre class="brush:kt;">
fun main() {
...
<style>
	...
	<div class="nav"><p><a href="./2.3.php">Назад</a><a href="./">Содержание</a><a href="./3.2.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
