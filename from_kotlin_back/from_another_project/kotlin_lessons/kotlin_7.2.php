...
<meta charset="utf-8" />
<meta name="description" content="Коллекция List в Kotlin, MutableList, типы и функции списков, получение элементов списка, вывод списка на консоль">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>List</h2><div class="date">Последнее обновление: 04.03.2024</div>
	<div class="socBlock">
...
<style>
	...
	<div class="nav"><p><a href="./7.1.php">Назад</a><a href="./">Содержание</a><a href="./7.3.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
