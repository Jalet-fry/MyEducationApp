...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Объектно-ориентированное программирование</h1><h2>Классы и объекты</h2><div class="date">Последнее обновление: 03.03.2024</div>
	<div class="socBlock">
...
в Kotlin не помещается в отдельный класс, а всегда определяется вне какого-либо класса.</p>
...
<style>
	...
	<div class="nav"><p><a href="./3.10.php">Назад</a><a href="./">Содержание</a><a href="./4.3.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
