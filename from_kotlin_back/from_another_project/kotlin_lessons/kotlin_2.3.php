...
<html  lang="ru">
<head>
<title>Kotlin | Ведение в массивы</title>
<meta charset="utf-8" />
<meta name="description" content="Ведение в массивы в языке программирования Kotlin, оператор in, тип Array, IntArray, функция arrayOf, размер массива">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Ведение в массивы</h2><div class="date">Последнее обновление: 04.03.2024</div>
	<div class="socBlock">
...
<p>Также можно использовать неявную типизацию и сразу передать набор значений массива:</p>
<pre class="brush:kt;">
val numbers = arrayOf(1, 2, 3, 4, 5)
</pre>
<p>В этом случае тип элементов массива будет выводиться из типа значений из функции <code>arrayOf()</code></p>
<p>Но что, если мы хотим создать массив, элементы которого будут не установлены (например, мы изначально не знаем, что это будут за элементы)? 
В этом случае для создания массива мы можем использовать встроенную функцию <b>arrayOfNulls()</b>. ОНа создает массив из элементов, каждый из который имеет значение 
...
<p>Также имеются один способо создать массив и инициализировать его значениями:</p>
<pre class="brush:kt;">
...
<style>
	...
	<div class="nav"><p><a href="./2.8.php">Назад</a><a href="./">Содержание</a><a href="./3.1.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
