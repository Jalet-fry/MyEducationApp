...
<html  lang="ru">
<head>
<title>Kotlin | Конструкция when</title>
<meta charset="utf-8" />
<meta name="description" content="Условная конструкция when в языке программирования Kotlin, выражение when..else, ">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Конструкция when</h2><div class="date">Последнее обновление: 02.03.2024</div>
	<div class="socBlock">
...
<p>Конструкция <span class="b">when</span> проверяет значение некоторого объекта и в зависимости от его значения выполняет тот или иной код. 
...
<p>Здесь в зависимости от значения переменной day в другой переменной - dayOfweek окажется та или иная строка.</p>
<p>Другой пример:</p>
<pre class="brush:kt;">
val sum = 1000
...
<style>
	...
	<div class="nav"><p><a href="./2.6.php">Назад</a><a href="./">Содержание</a><a href="./2.7.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
