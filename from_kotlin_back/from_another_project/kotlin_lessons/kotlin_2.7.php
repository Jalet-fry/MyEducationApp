...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Циклы</h2><div class="date">Последнее обновление: 26.03.2024</div>
	<div class="socBlock">
...
<h3>for</h3>
<p>Цикл <span class="b">for</span> пробегается по всем элементам коллекции. В этом плане цикл <span class="b">for</span> в Kotlin эквивалентен циклу <code>for-each</code> в ряде других языков программирования. 
...
<pre class="sh">1 	4 	9 	16 	25 	36 	49 	64 	81</pre>
...
<h3>do..while</h3>
<p>Есть и другая форма цикла while - do..while:</p>
<pre class="brush:kt;">
var i = -1
do{
	println(i*i)
...
<p>Однако следует помнить, что оператор <span class="b">break</span> выводит только из текущего цикла, где он вызывается. Например, возьмем следующую конструкцию с внешним и внутренним циклами:</p>
<pre class="brush:kt;">
fun main() {
...
<p>Сколько раз здесь будет выведена строка "Hello"? Очевидно 6 раз.</p>
<pre class="sh">
Hello
Hello
Hello
...
<p>Каждый раз во внутреннем цикле j окажется равна 3, произойдет переход к новой итерации внешнего цикла по i. Но что если нам надо вообще выйти из всех циклов, в том числе и из внешнего? 
Наиболее простым в данном случае способом будет использование меток:</p>
<pre class="brush:kt;">
fun main() {
...
<p>В данном случае внешний цикл маркирован меткой <code>outerloop</code>. Название метки произвольное, единственное, что заврешается символом <code>@</code>. И кода во внутреннем цикле будет 
выполняться условие <code>j == 3</code> оператор <span class="b">break</span> выйдет из цикла, предваряемого меткой <code>outerloop</code></p>
<pre class="brush:kt;">if(j == 3) break@outerloop;</pre>
...
<style>
	...
	<div class="nav"><p><a href="./2.11.php">Назад</a><a href="./">Содержание</a><a href="./2.8.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
