...
<html  lang="ru">
<head>
<title>Kotlin и Android | Создание тени и модификатор shadow</title>
<meta charset="utf-8" />
<meta name="description" content="Создание тени компонентов с помощью модификатора Modifier.shadow в Jetpack Compose и Kotlin и Android, форма и высота тени">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Создание тени и модификатор shadow</h2><div class="date">Последнее обновление: 29.03.2024</div>
	<div class="socBlock">
...
<p>Модификатор <span class="b">shadow</span> позволяет создать тень вокруг элемента. Этот модификатор имеет следующую форму:</p>
<pre class="brush:kt;">
fun Modifier.shadow(
    elevation: Dp,
...
<p>Функция модификатора принимает следующие параметры:</p>
<ul>
<li><p><code>elevation</code>: высота тени в dp</p></li>
<li><p><code>shape</code>: определяет форму тени с помощью объекта Shape</p></li>
<li><p><code>clip</code>: если равно <code>true</code>, то создается фрагмент с использованием формы из параметра shape</p></li>
<li><p><code>ambientColor</code>: цвет затенения на компоненте</p></li>
<li><p><code>spotColor</code>: цвет тени вокруг компонента</p></li>
</ul>
<p>Для создания тени нам достаточно задать ее высоту. Например:</p>
<pre class="brush:kt;">
...
<p>В данном случае вокруг компонента Text создается тень высотой в 3 единицы:</p>
<img src="./pics/3.20.png" alt="Модификатор shadow и создание тени компонентов в Jetpack Compose для Android на Kotlin" />
<p>Параметр <code>shape</code> позволяет задать форму тени. Он принимает объект интерфейса Shape. Например, определим округлую тень и для этого используем встроенный класс <span class="b">CircleShape</span>:</p>
<pre class="brush:kt;">
package com.example.helloapp
...
<img src="./pics/3.21.png" alt="Модификатор shadow и создание округлой тени компонентов в Jetpack Compose для Android на Kotlin" />
...
<style>
	...
	<div class="nav"><p><a href="./3.8.php">Назад</a><a href="./">Содержание</a><a href="./3.6.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
