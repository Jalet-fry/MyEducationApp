...
<html  lang="ru">
<head>
<title>Kotlin и Android | Переключатель Switch</title>
<meta charset="utf-8" />
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Переключатель Switch</h2><div class="date">Последнее обновление: 02.04.2024</div>
	<div class="socBlock">
...
<li><p><code>onCheckedChange</code>: функция обработки нажатия на компонент. Представляет функцию типа <code>(Boolean) -&gt; Unit</code>, 
в которую в качестве параметра передается новое состояние переключателя</p></li>	
<li><p><code>modifier</code>: объект типа <span class="b">Modifier</span>, который задает модификаторы компонента</p></li>	
<li><p><code>thumbContent</code>: содержимое для отрисовки переключателя</p></li>	
...
<p>В данном случае мы переключаем значение переменной textColor - если Switch находится в отмеченном состоянии, то она получает цвет Purple40. Для отображения изменения 
...
<p>По умолчанию Switch использует цвета, устанавливаемые функцией <span class="b">SwitchDefaults.colors</span>. Она имеет много параметров, поэтому отмечу лишь некоторые:</p>
<ul>
...
<li><p><code>checkedBorderColor</code>: цвет границы переключателя при отмеченном состоянии</p></li>
...
<li><p><code>uncheckedBorderColor</code>: цвет границы переключателя при неотмеченном состоянии</p></li>
...
<style>
	...
	<div class="nav"><p><a href="./4.14.php">Назад</a><a href="./">Содержание</a><a href="./4.16.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
