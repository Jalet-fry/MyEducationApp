...
<html  lang="ru">
<head>
<title>Kotlin и Android | Установка отступов и смещения</title>
<meta charset="utf-8" />
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Установка отступов и смещения</h2><div class="date">Последнее обновление: 29.03.2024</div>
	<div class="socBlock">
...
<style>
	...
	<div class="nav"><p><a href="./3.3.php">Назад</a><a href="./">Содержание</a><a href="./3.5.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
