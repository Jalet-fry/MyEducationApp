...
<html  lang="ru">
<head>
<title>Kotlin и Android | Пример навигации</title>
<meta charset="utf-8" />
<meta name="description" content="Пример навигации в мобильном приложении на Jetpack Compose на языке программирования Kotlin в Android, класс NavController, компонент NavHost, навигация по компонентами">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Пример навигации</h1><div class="date">Последнее обновление: 01.06.2025</div>
	<div class="socBlock">
...
<p>Для рассмотрения навигации определим следующее простейшее приложение:</p>
<pre class="brush:kt;">
...
<p>Итак, здесь для описания маршрутов применяется класс <span class="b">NavRoutes</span>, который через параметр получает маршрут. В этом классе определены три возможных маршрута - Home, Contacts и About.</p>
<p>Для каждого из этих маршуртов определены соответствующие одноименные компоненты:</p>
<pre class="brush:kt;">
@Composable
fun Home(){
    Text("Home Page", fontSize = 30.sp)
...
<p>Для простоты каждый компонент просто выводит некоторый текст.</p>
<p>ЧТобы в приложении можно было программно переходить по компонентам определена своего рода навигационная панель - компонент NavBar с тремя условными кнопками:</p>
<pre class="brush:kt;">
@Composable
fun NavBar(navController: NavController){
    Row(
...
<p>Этот компонент извне принимает объект NavController, с помощью метода navigate которого можно перейти по определенному маршруту.</p>
<p>И чтобы все это объединить определен компонент Main:</p>
<pre class="brush:kt;">
@Composable
fun Main() {
    val navController = rememberNavController()
...
<p>Вначале в нем создаем с помощью функции <code>rememberNavController()</code> объект NavController. Затем создаем вертикальную компоновку, где в верхней части располагается навигационная панель, а за ней идет 
компонент NavHost, внутри которого и разворачиваются навигационные компоненты. По умолчанию NavHost отображает компонент Home.</p>
<p>Запустим приложение и мы сможем переходить с помощью ссылок по различным компонентам в приложении:</p>
<img src="./pics/17.1.png" alt="Навигация в приложении на Jetpack Compose на Kotlin в Android" />
...
<style>
	...
	<div class="nav"><p><a href="./17.1.php">Назад</a><a href="./">Содержание</a><a href="./17.3.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
