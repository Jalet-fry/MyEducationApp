...
<html  lang="ru">
<head>
<title>Kotlin и Android | Первый проект</title>
<meta charset="utf-8" />
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Первый проект на Jetpack Compose</h1><div class="date">Последнее обновление: 27.05.2025</div>
	<div class="socBlock">
...
<img src="./pics/1.1.png" alt="Создание проекта Jetpack Compose в Android Studio" style=width:700px;" />
<p>Далее в открывшемся окне шаблонов проекта выберем пункт <span class="b">Empty Activity</span> и нажмем на кнопку <span class="b">Next</span>.</p>
<img src="./pics/1.2.png" alt="Создание проекта Jetpack Compose и Empty Activity в Android Studio" />
...
<li><p>В поле <span class="b">Minimum SDK</span> указывается самая минимальная поддерживаемая версия SDK. Оставим значение по умолчанию. В моем случае это 
<span class="b">API 24 ("Nougat"; Android 7.0)</span>, которая означает, что приложение можно будет запустить начиная с Android 7.0, а это 96% устройств. На более старых устройствах запустить будет нельзя.</p>
<p>Стоит учитывать, что чем выше версия SDK, тем меньше диапазон поддерживаемых устройств.</p></li>
<li><p>В поле <span class="b">Build configuration language</span> указывается язык, который применяется для определения конфигурации построения проекта. Оставим здесь значение по умолчанию.</p></li>
</ul>
...
Модуль по умолчанию включает три каталога:</p>
<ul>
...
<li><p><span class="b">kotlin+java</span>: хранит файлы кода на языке Kotlin, которые структурированы по отдельным пакетам. 
...
<p>Также в этой папке определен подкаталог <span class="b">ui.theme</span>, который содержит ряд файлов на языке Kotlin: <span class="b">Color.kt</span>, <span class="b">Theme.kt</span> и <span class="b">Type.kt</span>, которые определяют ряд вспомогательных типов, функций, переменных, применяемых 
...
<style>
	...
	<div class="nav"><p><a href="./1.4.php">Назад</a><a href="./">Содержание</a><a href="./1.3.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
