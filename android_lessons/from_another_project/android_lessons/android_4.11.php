...
<html  lang="ru">
<head>
<title>Kotlin и Android | Scaffold</title>
<meta charset="utf-8" />
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Scaffold</h2><div class="date">Последнее обновление: 01.04.2024</div>
	<div class="socBlock">
...
<li><p><code>containerColor</code>: фоновый цвет компонента Scaffold</p></li>
<li><p><code>contentColor</code>: цвет содержимого компонента Scaffold</p></li>	
<li><p><code>contentWindowInsets</code>: отступы от границ окна. Применяются только, если не установлены topBar/ bottomBar, иначе для определения отступов будут использоваться настройки 
topBar/bottomBar</p></li>	
...
<p>В данном случае Scaffold содержит один компонент Text. Стоит отметить, что при определении содержимого Scaffold с помощью функции content нам надо как-то задействовать ее параметр - значение 
PaddingValues. В данном случае значение it, который представляет параметр типа PaddingValues, передается в Text модификатору padding.</p>
...
<p>В данном случае для верхней и нижней панели применяются соответственно компоненты TopAppBar и BottomAppBar. Тем не менее это необязательно. Мы можем создавать свои собственные композиции компонентов в 
качестве подобных панелей.</p>
...
<style>
	...
	<div class="nav"><p><a href="./4.10.php">Назад</a><a href="./">Содержание</a><a href="./4.12.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
