...
<html  lang="ru">
<head>
<title>Kotlin и Android | Slider</title>
<meta charset="utf-8" />
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Slider</h2><div class="date">Последнее обновление: 02.04.2024</div>
	<div class="socBlock">
...
<li><p><code>interactionSource</code>: объект <span class="b">MutableInteractionSource</span>, который задает поток взаимодействий для поля ввода. </p></li>	
</ul>
...
<p>По умолчанию слайдер использует цвета, устанавливаемые компонентом <span class="b">SliderDefaults.colors</span>:</p>
<pre class="brush:kt;">
@Composable
fun colors(
...
<style>
	...
	<div class="nav"><p><a href="./4.13.php">Назад</a><a href="./">Содержание</a><a href="./4.15.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
