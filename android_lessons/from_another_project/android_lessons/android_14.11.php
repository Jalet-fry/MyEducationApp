...
<html  lang="ru">
<head>
<title>Kotlin и Android | Создание градиента</title>
<meta charset="utf-8" />
<meta name="description" content="Создание градиента на компоненте Canvas в мобильном приложении на Jetpack Compose на языке программирования Kotlin в Android, линейный и радиальный градиент">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Создание градиента</h2><div class="date">Последнее обновление: 14.04.2024</div>
	<div class="socBlock">
...
<p>Все фигуры позволяют использовать цвет для заливки фигуры или для создания ее контура. Для установки цвета можно использовать компонент Color или компонент <span class="b">Brush</span>. Но если 
Color представляет сплошной цвет, то <span class="b">Brush</span> позволяет создавать более сложное цветовое наполнение, например, в виде градиента различных типов.  
Например, чтобы заполнить прямоугольник горизонтальным градиентом, надо объект Brush инициализироваnm списком цветов - объектов Color вместе с начальным и конечным положением по оси X. Опционально можно указать параметр <code>tileMode</code>. </p>
<p>В следующем примере прямоугольник заполняется горизонтальным градиентом:</p>
<pre class="brush:kt;">
...
<img src="./pics/14.12.png" alt="Canvas и градиент в Jetpack Compose на Kotlin на Android" />
<p>Другой пример - заполнение радиальным градиентом окружности:</p>
<pre class="brush:kt;">
package com.example.helloapp
...
<img src="./pics/14.13.png" alt="Canvas и радиальный градиент в Jetpack Compose на Kotlin на Android" />
<p>Градиенты особенно полезны для добавления эффектов тени к рисункам. Например:</p>
<pre class="brush:kt;">
package com.example.helloapp
...
<img src="./pics/14.14.png" alt="Canvas и эффект тени с помощью градиента в Jetpack Compose на Kotlin на Android" />
...
<style>
	...
	<div class="nav"><p><a href="./14.10.php">Назад</a><a href="./">Содержание</a><a href="./15.1.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
