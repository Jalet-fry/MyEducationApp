...
<html  lang="ru">
<head>
<title>Kotlin и Android | Иконки и компоненты IconButton и IconToggleButton</title>
<meta charset="utf-8" />
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Иконки и компоненты IconButton и IconToggleButton</h2><div class="date">Последнее обновление: 31.03.2024</div>
	<div class="socBlock">
...
<style>
	...
	<div class="nav"><p><a href="./4.5.php">Назад</a><a href="./">Содержание</a><a href="./4.9.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
