...
<html  lang="ru">
<head>
<title>Kotlin и Android | Диалоговые окна AlertDialog</title>
<meta charset="utf-8" />
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Диалоговые окна AlertDialog</h2><div class="date">Последнее обновление: 01.04.2024</div>
	<div class="socBlock">
...
<li><p><code>confirmButton</code>: представляет функцию типа <code>() -&gt; Unit</code>, в которой устанавливается кнопка подтверждения действия.</p></li>
<li><p><code>modifier</code>: объект типа <span class="b">Modifier</span>, который задает модификаторы компонента</p></li>
<li><p><code>dismissButton</code>: представляет функцию типа <code>() -&gt; Unit</code>, в которой устанавливается кнопка отмены действия.</p></li>
<li><p><code>icon</code>: иконка, которая отображается над заголовков или текстом</p></li>
...
<li><p><code>shape</code>: устанавливает форму диалогового окна в виде объекта <span class="b">Shape</span></p></li>
<li><p><code>containerColor</code>: устанавливает фоновый цвет окна</p></li>
<li><p><code>iconContentColor</code>: устанавливает цвет для иконки</p></li>  	
<li><p><code>titleContentColor</code>: устанавливает цвет заголовка окна</p></li>
<li><p><code>textContentColor</code>: устанавливает цвет текста окна</p></li>
<li><p><code>tonalElevation</code>: устанавливает эффект анимации</p></li>
<li><p><code>properties</code>: дополнительные свойства для настройки окна, которые представляют объект <span class="b">DialogProperties</span></p></li>
</ul>
<p>Для создания диалогового окна достаточно установить параметры <code>onDismissRequest</code> и <code>confirmButton</code>.</p>
...
<p>Подобным образом можно настроить и другие аспекты окна. Например, добавим еще кнопку:</p>
<pre class="brush:kt;">
package com.example.helloapp
...
<p>Единственное что стоит отметить, что кнопка dismissedButton отображается перед кнопки confirmButton.</p>
...
<style>
	...
	<div class="nav"><p><a href="./4.15.php">Назад</a><a href="./">Содержание</a><a href="./4.17.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
