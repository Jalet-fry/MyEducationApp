...
<html  lang="ru">
<head>
<title>Kotlin и Android | Отрисовка изображений</title>
<meta charset="utf-8" />
<meta name="description" content="Отрисовка изображений на компоненте Canvas с помощью функции drawImage в мобильном приложении на Jetpack Compose на языке программирования Kotlin в Android">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Отрисовка изображений</h2><div class="date">Последнее обновление: 14.04.2024</div>
	<div class="socBlock">
...
<p>Для отрисовки изображений применяется функция <span class="b">drawImage()</span>. Она имеет ряд версий. Простая версия:</p>
<pre class="brush:kt;">
fun drawImage(
    image: ImageBitmap,
...
<ul>
<li><p><code>image</code>: изображение - объект ImageBitmap  для отрисовки</p></li>
<li><p><code>topLeft</code>: координаты верхнего левого угла на Canvas</p></li>
<li><p><code>alpha</code>: прозрачность, применяемая к изображению в виде значения из диапазона от 0.0f до 1.0f</p></li>
<li><p><code>style</code>: стиль заполнения изображения</p></li>
<li><p><code>colorFilter</code>: цветовой фильтр ColorFilter, который применяется к изображению</p></li>
<li><p><code>blendMode</code>: алгоритм смешивания, применяемый к изображению</p></li>
</ul>
<p>Другая версия функции:</p>
<pre class="brush:kt;">
fun drawImage(
    image: ImageBitmap,
...
<p>Здесь добавлется четыре параметра, которые позволяют вывести часть изображения в определенную часть на Canvas:</p>
<ul>
<li><p><code>srcOffset</code>: смещение на оригинальном изображении, откуда надо взять часть изображения</p></li>
<li><p><code>srcSize</code>: прямоугольная область, которая берется из оригинального изображения</p></li>
<li><p><code>dstOffset</code>: смещение верхнего левого угла, на который будет позиционироваться изображение</p></li>
<li><p><code>dstSize</code>: прямоугольная область, в которую вписывается изображение</p></li>
</ul>
<p>Допустим, в папку <span class="b">res/drawable</span> добавлено некоторое изображение. В моем случае это файл "forest.png"</p>
<img src="./pics/14.19.png" alt="Canvas и вывод изображения в Jetpack Compose на Kotlin на Android" />
<p>Выведем это изображение на Canvas:</p>
<pre class="brush:kt;">
...
<img src="./pics/14.20.png" alt="Canvas и drawImage и вывод изображения в Jetpack Compose на Kotlin на Android" />
...
<style>
	...
	<div class="nav"><p><a href="./14.8.php">Назад</a><a href="./">Содержание</a><a href="./14.10.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
