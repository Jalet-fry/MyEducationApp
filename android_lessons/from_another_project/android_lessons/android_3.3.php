...
<html  lang="ru">
<head>
<title>Kotlin и Android | Установка размеров</title>
<meta charset="utf-8" />
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Установка размеров</h2><div class="date">Последнее обновление: 29.03.2024</div>
	<div class="socBlock">
...
<p>Для установки применяются единицы <span class="b">dp</span> (device-independent pixels/density-independent pixels или независимые от устройства/плотности пиксели).</p>
...
<p>Модификаторы <code>width</code> и <code>height</code>, как и другие модификаторы установки размеров, определены в пакете <code>androidx.compose.foundation.layout</code>. Мы их можем импортировать по отдельности:</p>
<pre class="brush:kt;">
import androidx.compose.foundation.layout.height
import androidx.compose.foundation.layout.width
</pre>
<p>Также можно подключить сразу все подобные модификаторы, что удобно при использовании сразу нескольких из них:</p>
<pre class="brush:kt;">
...
<pre class="brush:kt;">modifier = Modifier.background(color=Color.LightGray).size(300.dp)</pre>
...
<style>
	...
	<div class="nav"><p><a href="./3.2.php">Назад</a><a href="./">Содержание</a><a href="./3.4.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
