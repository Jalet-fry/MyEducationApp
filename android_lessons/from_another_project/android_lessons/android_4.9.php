...
<html  lang="ru">
<head>
<title>Kotlin и Android | FloatingActionButton и ExtendedFloatingActionButton</title>
<meta charset="utf-8" />
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>FloatingActionButton и ExtendedFloatingActionButton</h2><div class="date">Последнее обновление: 30.03.2024</div>
	<div class="socBlock">
...
<li><p><code>containerColor</code>: фоновый цвет компонента. По умолчанию имеет значение <code>MaterialTheme.colors.secondary</code></p></li> 	
...
<style>
	...
	<div class="nav"><p><a href="./4.8.php">Назад</a><a href="./">Содержание</a><a href="./4.10.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
