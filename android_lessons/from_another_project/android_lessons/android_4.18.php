...
<html  lang="ru">
<head>
<title>Kotlin и Android | Индикаторы прогресса</title>
<meta charset="utf-8" />
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Индикаторы прогресса</h2><div class="date">Последнее обновление: 01.04.2024</div>
	<div class="socBlock">
...
<ul>
<li><p><code>progress</code>: функция, которая устанавливает значение индикатора в виде объекта Float. Это значение находится в диапазаоне от 0.0 (процесс еще не начался) 
...
<li><p><code>trackColor</code>: цвет дорожки индикатора</p></li> 
<li><p><code>strokeCap</code>: тип линий индикатора</p></li> 
<li><p><code>gapSize</code>: зазор между индикатором и дорожкой</p></li> 		
</ul>
...
до 1.0 (завершение процесса).</p></li> 	
<li><p><code>modifier</code>: представляет объект <span class="b">Modifier</span>, который определяет модификаторы компонента</p></li>  	
<li><p><code>color</code>: цвет закрашенной части дорожки индикатора (пройденная часть)</p></li>
<li><p><code>trackColor</code>: цвет незакрашенной части дорожки индикатора (еще непройденная часть)</p></li> 	
<li><p><code>strokeCap</code>: тип линий индикатора</p></li> 	
<li><p><code>gapSize</code>: зазор между дорожкой и индикатором</p></li> 	
<li><p><code>drawStopIndicator</code>: функция, которая вызывается для отрисовки индикатора остановки</p></li> 	
</ul>
<p>Определим индикацию процесса с помощью <span class="b">LinearProgressIndicator</span>:</p>
<pre class="brush:kt;">
package com.example.helloapp
...
<p>Параметры color и trackColor позволяют настроить цветовую схему индикатора:</p>
<pre class="brush:kt;">
package com.example.helloapp
...
<style>
	...
	<div class="nav"><p><a href="./4.17.php">Назад</a><a href="./">Содержание</a><a href="./4.20.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
