...
<html  lang="ru">
<head>
<title>Kotlin и Android | Surface</title>
<meta charset="utf-8" />
<meta name="description" content="Контейнер компоновки Surface и его параметры в Jetpack Compose на языке программирования Kotlin на Android, стилизация вложенных компонентов">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Surface</h2><div class="date">Последнее обновление: 03.04.2024</div>
	<div class="socBlock">
...
<p>Компонент <span class="b">Surface</span> является ключевым компонентом компоновки в Material Design, предоставляя для вложенного содердимого множество стилизаций по умолчанию. Он имеет несколько версий. Возьмем простейшую из них:</p>
<pre class="brush:kt;">
@Composable
...
<p>Данная версия функции компонента принимает следующие параметры:</p>
<ul>
<li><p><code>modifier</code>: применяемые к контейнеру функции модификатора</p></li>

<li><p><code>shape</code>: форма компонента в виде объекта Shape</p></li>

<li><p><code>color</code>: фоновый цвет</p></li>

<li><p><code>contentColor</code>: предпочитаемый цвет содержимого</p></li>

<li><p><code>tonalElevation</code>: эффект анимации при нажатии</p></li>

<li><p><code>shadowElevation</code>: высота тени</p></li>

<li><p><code>border</code>: параметры границы в виде объекта BorderStroke</p></li>
</ul>
<p>Например, простейший SUrface:</p>
<pre class="brush:kt;">
...
<img src="./pics/4.75.png" alt="Surface в Jetpack Compose и Kotlin на Android" />
<p>В данном случае мы видим, что текст в качестве цвета использовал настройки Surface.</p>
<p>При этом Surface может одновременно содержать только один компонент, поэтому при использовании множества компонентов, их следует оборачивать в другой контейнер типа Box, Row или Column:</p>
<pre class="brush:kt;">
package com.example.helloapp
...
<img src="./pics/4.76.png" alt="Surface и стилизация в Jetpack Compose и Kotlin на Android" />
...
<style>
	...
	<div class="nav"><p><a href="./2.4.php">Назад</a><a href="./">Содержание</a><a href="./2.6.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
