...
<html  lang="ru">
<head>
<title>Kotlin и Android | Отрисовка кругов и овалов</title>
<meta charset="utf-8" />
<meta name="description" content="Отрисовка кругов и овалов на компоненте Canvas с помощью функции drawCircle и drawOval в мобильном приложении на Jetpack Compose на языке программирования Kotlin в Android">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Отрисовка кругов и овалов</h2><div class="date">Последнее обновление: 14.04.2024</div>
	<div class="socBlock">
...
<p>Для рисования окруженостей применяется функция <span class="b">drawCircle()</span>:</p>
<pre class="brush:kt;">
fun drawCircle(
    color: Color,
...
<ul>
<li><p><code>color</code>: цвет окружности</p></li>
<li><p><code>center</code>: точка верхнего левого углацентра окружености (значение типа Offset)</p></li>
<li><p><code>radius</code>: радиус окружности</p></li>
<li><p><code>alpha</code>: прозрачность, применяемая к цвету окружности в виде значения из диапазона от 0.0f до 1.0f</p></li>
<li><p><code>style</code>: стиль заполнения окружности (значение DrawStyle)</p></li>
<li><p><code>colorFilter</code>: цветовой фильтр ColorFilter, который применяется к цвету окружности</p></li>
<li><p><code>blendMode</code>: алгоритм смешивания, применяемый к цвету</p></li>
</ul>
<p>Пример рисования окружности:</p>
<pre class="brush:kt;">
...
<img src="./pics/14.10.png" alt="Canvas и drawCircle в Jetpack Compose на Kotlin на Android" />
<p>Для отрисовки овалов применяется функция <span class="b">drawOval()</span></p>
<pre class="brush:kt;">
fun drawOval(
    color: Color,
...
<p>Эта функция принимает следующие параметры:</p>
<ul>
<li><p><code>color</code>: цвет овала</p></li>
<li><p><code>topLeft</code>: точка верхнего левого угла (значение типа Offset)</p></li>
<li><p><code>size</code>: размер овала</p></li>
<li><p><code>alpha</code>: прозрачность, применяемая к цвету овала в виде значения из диапазона от 0.0f до 1.0f</p></li>
<li><p><code>style</code>: стиль заполнения овала (значение DrawStyle)</p></li>
<li><p><code>colorFilter</code>: цветовой фильтр ColorFilter, который применяется к цвету овала</p></li>
<li><p><code>blendMode</code>: алгоритм смешивания, применяемый к цвету</p></li>
</ul>
<p>По сути эта функция описывает прямоугольник, в который вписывается овал. Пример отрисовки овала:</p>
<pre class="brush:kt;">
package com.example.helloapp
...
<img src="./pics/14.11.png" alt="Canvas и drawOval в Jetpack Compose на Kotlin на Android" />
