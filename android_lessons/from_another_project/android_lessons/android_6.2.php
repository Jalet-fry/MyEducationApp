...
<html  lang="ru">
<head>
<title>Kotlin и Android | Ресурсы изображений и ImageBitmap</title>
<meta charset="utf-8" />
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Ресурсы изображений и ImageBitmap</h2><div class="date">Последнее обновление: 04.04.2024</div>
	<div class="socBlock">
...
<p>Далее при копировании файла нам будет предложено установить для него новое имя (по умолчанию подставляется текущее имя файла)</p>
...
<style>
	...
	<div class="nav"><p><a href="./6.1.php">Назад</a><a href="./">Содержание</a><a href="./6.3.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
