...
<html  lang="ru">
<head>
<title>Kotlin и Android | Векторная графика и ImageVector</title>
<meta charset="utf-8" />
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Векторная графика и ImageVector</h2><div class="date">Последнее обновление: 04.04.2024</div>
	<div class="socBlock">
...
<p>Также мы можем использовать <b>ImageVector</b> для загрузки векторной графики, которая хранится в ресурсах приложения. Для хранения векторной графики, как и вообще изображений, в проекте предназначена папка <span class="b">res/drawable</span>:</p>
...
<p>Теперь изменим код в файле <span class="b">MainActivity.kt</span> для загрузки этой звезды:</p>
<pre class="brush:kt;">
package com.example.helloapp
...
<style>
	...
	<div class="nav"><p><a href="./6.2.php">Назад</a><a href="./">Содержание</a><a href="./8.1.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
