...
<html  lang="ru">
<head>
<title>Kotlin и Android | Checkbox</title>
<meta charset="utf-8" />
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Checkbox</h2><div class="date">Последнее обновление: 31.03.2024</div>
	<div class="socBlock">
...
<img src="./pics/4.65.png" alt="Флажок Checkbox и переключение состояния в Jetpack Compose и Kotlin в Android" />
...
<p>Из параметров компонента следует отметить параметр <code>colors</code>, который представляет тип <code>CheckboxColors</code> и устанавливает цветовую гамму флажка. 
...
<li><p><code>disabledCheckedColor</code>: цвет флажка, когда он отмечен, но не доступен для нажатия</p></li>
<li><p><code>disabledUncheckedColor</code>: цвет флажка, когда он не отмечен и не доступен для нажатия</p></li>
...
<style>
	...
	<div class="nav"><p><a href="./4.7.php">Назад</a><a href="./">Содержание</a><a href="./4.6.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
