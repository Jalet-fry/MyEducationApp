...
<html  lang="ru">
<head>
<title>Java | Модификаторы доступа и класс Modifier</title>
<meta charset="utf-8" />
<meta name="description" content="Получение модификаторов полей и методов с помощью рефлексии в программе на языке программирования Java, метод getModifiers, получение и изменение значения поля произвольного объекта">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Модификаторы доступа и класс Modifier</h1><div class="date">Последнее обновление: 29.09.2025</div>
	<div class="socBlock">
...
<p>Классы <span class="b">Field</span> (поле класса), <span class="b">Method</span> (метод класса) и <span class="b">Constructor</span> (конструктор класса) имеют метод <code>getModifiers()</code>, 
который возвращает целое число с различными включенными и выключенными битами, которые описывают используемые модификаторы, такие как <code>public</code> и 
<code>static</code>. Затем можно использовать статические методы класса <code>Modifier</code> для анализа целого числа, возвращаемого <code>getModifiers()</code>:</p>

<ul>
<li><p><code>boolean isAbstract(int mod)<code>:  возвращает <code>true</code>, если параметр <code>mod</code> содержит модификатор <span class="b">abstract</span></p></li>
<li><p><code>boolean isFinal(int mod)<code>:  возвращает <code>true</code>, если параметр <code>mod</code> содержит модификатор <span class="b">final</span></p></li>
<li><p><code>boolean isInterface(int mod)<code>:  возвращает <code>true</code>, если параметр <code>mod</code> содержит модификатор <span class="b">interface</span></p></li>
<li><p><code>boolean isNative(int mod)<code>:  возвращает <code>true</code>, если параметр <code>mod</code> содержит модификатор <span class="b">native</span></p></li>
<li><p><code>boolean isPrivate(int mod)<code>:  возвращает <code>true</code>, если параметр <code>mod</code> содержит модификатор <span class="b">private</span></p></li>
<li><p><code>boolean isProtected(int mod)<code>:  возвращает <code>true</code>, если параметр <code>mod</code> содержит модификатор <span class="b">protected</span></p></li>
<li><p><code>boolean isPublic(int mod)<code>:  возвращает <code>true</code>, если параметр <code>mod</code> содержит модификатор <span class="b">public</span></p></li>
<li><p><code>boolean isStatic(int mod)<code>:  возвращает <code>true</code>, если параметр <code>mod</code> содержит модификатор <span class="b">static</span></p></li>
<li><p><code>boolean isSynchronized(int mod)<code>:  возвращает <code>true</code>, если параметр <code>mod</code> содержит модификатор <span class="b">synchronized</span></p></li>
<li><p><code>boolean isTransient(int mod)<code>:  возвращает <code>true</code>, если параметр <code>mod</code> содержит модификатор <span class="b">transient</span></p></li>
<li><p><code>boolean isVolatile(int mod)<code>:  возвращает <code>true</code>, если параметр <code>mod</code> содержит модификатор <span class="b">volatile</span></p></li>
</ul>
<p>Исследуем модификаторы полей:</p>
...
<p>В данном случае получаем все поля класса Person. Затем в цикле переьираем каждое поле, получаем его модификаторы и смотрим, представляют они <code>public</code>, <code>protected</code>. 
<code>private</code> или <code>static</code>:</p>
<pre class="brush:java;">
for(Field f : fields){
    // получаем модификаторы
    int mod = f.getModifiers();
...
<p>Затем получаем тип и имя поля и выводим на консоль. В итоге мы получим следующий консольный вывод:</p>
<pre class="sh">
public java.lang.String name;
private int id;
private static int count;
</pre>
<p>Для вывода модификаторов можно использовать метод <code>Modifier.toString()</code>. Например:</p>
<pre class="brush:java;">
import java.lang.reflect.*;
...
<p>Для получения модификаторов в виде строки передаем целочисленный код модификаторов в метод <code>Modifier.toString()</code></p>
<pre class="brush:java;">String modifiers = Modifier.toString(f.getModifiers());</pre>
...
<style>
	...
	<div class="nav"><p><a href="./14.3.php">Назад</a><a href="./">Содержание</a><a href="./14.5.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
