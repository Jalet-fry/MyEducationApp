...
<html  lang="ru">
<head>
<title>Java | Связанный список LinkedList</title>
<meta charset="utf-8" />
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Связанный список LinkedList</h1><div class="date">Последнее обновление: 11.10.2025</div>
	<div class="socBlock">
	...
	<p>Обобщенный класс LinkedList&lt;E&gt; представляет структуру данных в виде связанного списка. Он наследуется от класса <code>AbstractSequentialList</code> и реализует интерфейсы 
<code>List, Dequeue</code> и <code>Queue</code>. 
...
<p>Рассмотрим применение некоторых методов связанного списка. Добавление в список:</p>
...
<p>Получение, изменение, перебор и проверка на наличие в списке:</p>
<pre class="brush:java;">
import java.util.LinkedList;
...
<style>
	...
	<div class="nav"><p><a href="./5.7.php">Назад</a><a href="./">Содержание</a><a href="./5.4.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
