...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Чтение и запись файлов. FileInputStream и FileOutputStream</h2><div class="date">Последнее обновление: 08.03.2023</div>
	<div class="socBlock">
...
<p>В данном случае с помощью метода <code>read()</code> считываем данные в массив buffer длиной 256 байтов. Метод возвращает количество считанных байтов.</p>
<p>Поскольк файл может быть больше 256 байтов, то считываем в цикле while до конца файла. Когда больше не останется файлов для считывания, то метод возвратит -1.</p>
<pre class="brush:java;">while((count=fin.read(buffer))!=-1){</pre>
<p>Поскольку количество считанных байтов/размер файла могут быть меньше 256 байт, то реальное количество считанных байт сохраняем в переменную count. Затем выводим считанное количество данных на консоль 
в цикле for.</p>
<pre class="brush:java;">
for(int i=0; i&lt;count;i++){
...
<style>
	...
	<div class="nav"><p><a href="./6.1.php">Назад</a><a href="./">Содержание</a><a href="./6.2.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
