...
<html  lang="ru">
<head>
<title>Java | Деревья TreeSet и интерфейсы SortedSet и NavigableSet</title>
<meta charset="utf-8" />
<meta name="description" content="Деревья TreeSet в языке программирования Java, интерфейсы SortedSet и NavigableSet, древовидные структуры данных, харнение неупорядоченных данных в отсортированном виде в дереве">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Деревья TreeSet и интерфейсы SortedSet и NavigableSet</h1><div class="date">Последнее обновление: 11.10.2025</div>
	<div class="socBlock">
...
возрастанию). <b>SortedSet</b> расширяет интерфейс <code>Set</code>, поэтому такая коллекция опять же хранит только уникальные значения. 
...
<p>Добавление элемента в дерево происходит медленнее, чем добавление его в хеш-таблицу HashSet, но всt равно намного быстрее, чем проверка на наличие дубликатов в массиве или связном списке. 
Если дерево содержит n элементов, то для поиска правильной позиции нового элемента требуется в среднем <code>log<sub>2</sub>n</code> сравнений. Например, если дерево уже содержит 1000 элементов, добавление нового элемента потребует около 10 сравнений.</p>

<p>И поскольку <code>TreeSet</code> при добавлении сравнивает объекты, они должны реализовывать интерфейс <b>Comparable</b>. Либо необходимо предоставить объект интерфейса <b>Comparator</b> 
при создании дерева TreeSet.</p>
...
<p>TreeSet поддерживает все стандартные методы для вставки и удаления элементов и ряд других методов:</p>
<ul>
<li><p><code>boolean add(E e)</code>: Добавляет указанный элемент в этот набор, если он ещё отсутствует</p></li>
<li><p><code>boolean addAll(Collection&lt;? extends E&gt; c)</code>: Добавляет все элементы указанной коллекции в этот набор</p></li>
<li><p><code>E ceiling(E e)</code>: Возвращает наименьший элемент в этом наборе, больший или равный заданному, или null, если такого элемента нет</p></li>
<li><p><code>void clear()</code>: Удаляет все элементы из этого набора</p></li>
<li><p><code>Object clone()</code>: Возвращает поверхностную копию данного экземпляра TreeSet</p></li>
<li><p><code>Comparator&lt;? super E&gt; comparator()</code>: Возвращает компаратор, используемый для упорядочивания элементов в этом наборе, или null, если набор использует естественный порядок своих элементов</p></li>
<li><p><code>boolean contains(Object o)</code>: Возвращает true, если набор содержит указанный элемент</p></li>
<li><p><code>Iterator&lt;E&gt; descendingIterator()</code>: Возвращает итератор по элементам набора в порядке убывания</p></li>
<li><p><code>NavigableSet&lt;E&gt; descendingSet()</code>: Возвращает обратный порядок элементов набора</p></li>
<li><p><code>E first()</code>: Возвращает первый (самый низкий) элемент в наборе</p></li>
<li><p><code>E floor(E e)</code>: Возвращает наибольший элемент набора, меньший или равный заданному, или null, если такого элемента нет</p></li>
<li><p><code>SortedSet&lt;E&gt; headSet(E toElement)</code>: Возвращает представление части набора, элементы которой строго меньше toElement</p></li>
<li><p><code>NavigableSet&lt;E&gt; headSet(E toElement, boolean inclusive)</code>: Возвращает представление части данного множества, элементы которой меньше (или равны, если inclusive равно true) toElement</p></li>
<li><p><code>E higher(E e)</code>: Возвращает наименьший элемент в данном множестве, строго больший заданного элемента, или null, если такого элемента нет</p></li>
<li><p><code>boolean isEmpty()</code>: Возвращает true, если в данном множестве нет элементов</p></li>
<li><p><code>Iterator&lt;E&gt; iterator()</code>: Возвращает итератор по элементам данного множества в порядке возрастания</p></li>
<li><p><code>E last()</code>: Возвращает последний (наивысший) элемент в данном множестве в данный момент</p></li>
<li><p><code>E lower(E e)</code>: Возвращает наибольший элемент в данном множестве, строго меньший заданного элемента, или null, если такого элемента нет</p></li>
<li><p><code>E pollFirst()</code>: Извлекает и удаляет первый (наименьший) элемент или возвращает null, если данное множество пусто (необязательная операция)</p></li>
<li><p><code>E pollLast()</code>: Извлекает и удаляет последний (самый высокий) элемент или возвращает null, если набор пуст (необязательная операция)</p></li>
<li><p><code>boolean remove(Object o)</code>: Удаляет указанный элемент из набора, если он присутствует</p></li>
<li><p><code>int size()</code>: Возвращает количество элементов в дереве</p></li>
<li><p><code>NavigableSet&lt;E&gt; subSet(E fromElement, boolean fromInclusive, E toElement, boolean toInclusive)</code>: Возвращает представление части набора, элементы которой находятся в диапазоне от fromElement до toElement</p></li>
<li><p><code>SortedSet&lt;E&gt; subSet(E fromElement, E toElement)</code>: Возвращает представление части набора, элементы которой находятся в диапазоне от fromElement (включительно) до toElement (исключительно)</p></li>
<li><p><code>SortedSet&lt;E&gt; tailSet(E fromElement)</code>: Возвращает представление части данного набора, элементы которой больше или равны fromElement</p></li>
<li><p><code>NavigableSet&lt;E&gt; tailSet(E fromElement, boolean inclusive)</code>: Возвращает представление части данного набора, элементы которой больше (или равны, если inclusive равно true) fromElement</p></li>
</ul>
...
<p>И поскольку при вставке объекты сразу же сортируются по возрастанию, то при выводе мы получим отсортированный набор:</p>
<pre class="sh">
langs size: 4 
[C++, Java, JavaScript, Python]
[C++, Java, Python]
</pre>
<p>Так как TreeSet реализует интерфейс NavigableSet, а через него и SortedSet, то мы можем применить к структуре дерева различные методы для получения элементов:</p>
<pre class="brush:java;">
import java.util.TreeSet;
...
<style>
	...
	<div class="nav"><p><a href="./5.4.php">Назад</a><a href="./">Содержание</a><a href="./5.8.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
