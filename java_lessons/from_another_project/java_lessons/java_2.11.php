...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Структура программы на Java</h1><div class="date">Последнее обновление: 23.05.2025</div>
	<div class="socBlock">
...
<p>Данная строка представляет вызов метода <code>System.out.println</code>, который выводит на консоль строку "Hello METANIT.COM!". В данном случае вызов 
...
<h3>Сокращенные файлы кода и методы main c JDK 25</h3>
<p>С выходом JDK 21 появилась экспериментальная функция, которая позволяет упростить программу на Java. В JDK 25 эта возможность перестает быть экспериментальной и стала полноценной для применения. Суть 
этой возможности: теперь можно писать код без объявления класса с сокращением определения кода <b>main</b>. Например, также определим файл <span class="b">Program.java</span>, в котором будет следующий код:</p>
<pre class="brush:java;">
void main() {
    System.out.println("Hello METANIT.COM!");
}
</pre>
<p>Как можно увидеть, данный код значительно короче предыдущего, что упрощает написание программ. Версии JDK 21, 22, 23 и 24 поддерживали такое определение метода main в качестве экспериментального, а для компиляции программы надо 
было указывать дополнительные опции. Например, для компиляции с помощью JDK 22 применялась команда:</p>
...
<p>Начиная с версии JDK 25 никаких дополнительных опций ни при компиляции, ни при запуске программы указывать не нужно:</p>
<pre class="sh">
...
<p>Также можно явным образом оформить метод main в класс:</p>
<pre class="brush:java;">
class Program{
    void main() {
        System.out.println("Hello METANIT.COM");
...
<style>
	...
	<div class="nav"><p><a href="./1.7.php">Назад</a><a href="./">Содержание</a><a href="./2.1.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
