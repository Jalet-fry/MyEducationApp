...
<meta charset="utf-8" />
<meta name="description" content="Работа со строками в языке программирования Java, класс String и его методы">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Введение в строки. Класс String</h1><div class="date">Последнее обновление: 16.09.2025</div>
	<div class="socBlock">
	...
	<p>Строка представляет собой последовательность символов. Для работы со строками в Java определен класс <b>String</b>, который предоставляет ряд методов для манипуляции строками. 
...
<h3>Длина строк. Пустые строки и null</h3>
...
<li><p><span class="b">strip()</span>: удаляет начальные и конечные пробелы</p></li>
...
<style>
	...
	<div class="nav"><p><a href="./6.13.php">Назад</a><a href="./">Содержание</a><a href="./7.2.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
