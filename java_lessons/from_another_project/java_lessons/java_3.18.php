...
<html  lang="ru">
<head>
<title>Java | Классы Records</title>
<meta charset="utf-8" />
<meta name="description" content="Классы Records в Java, ключевое слово record, канонический конструктор, определение полей, переопределение конструкторов и методов, ограничения классов record">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Классы Records</h1><div class="date">Последнее обновление: 22.09.2025</div>
	<div class="socBlock">
...
<span class="b">Records</span> представляют классы, состояние которых неизменяемо (immutable), а их поля доступны для внешнего кода. Кроме того, records позволяют упростить разработку, 
сократив объем кода. По сути record - это более удобная компактная форма определения контейнера неизменяемых данных.</p>
...
<pre class="sh">Person[name=Tom, age=36]</pre>
...
<pre class="sh">Person[name=Tom, age=18]</pre>
...
<pre class="sh">Person[name=Tom Smith, age=36]</pre>
...
<style>
	...
	<div class="nav"><p><a href="./3.13.php">Назад</a><a href="./">Содержание</a><a href="./9.4.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
