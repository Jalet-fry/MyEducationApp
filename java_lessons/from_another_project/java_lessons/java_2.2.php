...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Преобразования базовых типов данных</h1><div class="date">Последнее обновление: 16.09.2025</div>
	<div class="socBlock">
...
<pre class="brush:java;">
import java.lang.Math;  // для Math.round
...
</fieldset></div>	<div class="nav"><p><a href="./2.15.php">Назад</a><a href="./">Содержание</a><a href="./2.5.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
