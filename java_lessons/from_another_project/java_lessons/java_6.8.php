...
<div class="innercontainer">
   ...
   <div class="item center menC">
	...
	<p>Хотя с помощью ранее рассмотренных классов можно записывать текст в файлы, однако они предназначены прежде всего для работы с бинарными 
...
<style>
	...
	<div class="nav"><p><a href="./6.7.php">Назад</a><a href="./">Содержание</a><a href="./6.9.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
