...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Ссылочные типы и копирование объектов</h1><div class="date">Последнее обновление: 29.09.2025</div>
	<div class="socBlock">
...
<img src="./pics/3.2_1.png" alt="Клонирование объектов в Java" />
<h3>Метод clone</h3>
...
<p>Однако выше описанный способ осуществляет <span class="b">неполное копирование</span> (shallow copy) и подойдет, если клонируемый объект не содержит сложных объектов. Например, 
пусть класс Person имеет поле, которое хранит ссылку на объект Company - условно место работы человека:</p>
<pre class="brush:java;">
class Company{
...
<p>Класс Person по прежнему реализует метод <code>clone()</code>, то есть с копированием вроде не должно быть проблем:</p>
<pre class="brush:java;">
public class Program{
...
<p>Но посмотрим на консольный вывод программы:</p>
<pre class="sh">
Person Tom works in Google
Person Bob works in Google
</pre>
<p>В этом случае, хотя переменные tom и bob будут указывать на разные объекты в памяти, но эти объекты при этом будут указывать на один объект 
Company.</p>
<img src="./pics/3.3_1.png" alt="Неполное копирование объектов в Java" />
<p>И в этом случае нам необходимо выполнить полное копирование или так называниемое "глубокое копирование" (deep copy). Для этого надо определить метод клонирования и у класса Company:</p>
<pre class="brush:java;">
...
<p>И затем исправим метод <code>clone()</code> в классе Person следующим образом:</p>
<pre class="brush:java;">
class Person implements Cloneable{
...
<p>Код класса Program остается тем же:</p>
<pre class="brush:java;">
public class Program{
...
<p>Но теперь мы получим другой консольный вывод:</p>
<pre class="sh">
...
<style>
	...
	<div class="nav"><p><a href="./3.32.php">Назад</a><a href="./">Содержание</a><a href="./3.18.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
