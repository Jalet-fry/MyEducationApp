...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Математические вычисления и класс Math</h1><div class="date">Последнее обновление: 16.09.2025</div>
	<div class="socBlock">
...
<li><p><code>clamp(double num, double a, double b)</code>: заставляет число num вписываться в заданные границы - между a и b - если num меньше a, то возвращается a, если num больше b, то возвращается b</p>:
<pre class="brush:java;">
import java.lang.Math;
...
public class Program{
	...
	public static void main(String[] args) {
        ...
        System.out.println(Math.clamp(-1, 0, 5)); // -1 не входит в границы дипазаона [0, 5], поэтому возвращается 0
        System.out.println(Math.clamp(6, 0, 5)); // 6 не входит в границы дипазаона [0, 5], поэтому возвращается 5
        System.out.println(Math.clamp(4, 0, 5)); // 4 входит в границы дипазаона [0, 5], поэтому возвращается 4
    }
}
</pre>
...
<p>Также класс Math определяет три константы: <code>Math.E</code>, <code>Math.TAU</code> и <code>Math.PI</code>. Например, вычислим площадь круга:</p>
<pre class="brush:java;">
import java.lang.Math;
...
<style>
	...
	<div class="nav"><p><a href="./11.3.php">Назад</a><a href="./">Содержание</a><a href="./12.2.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
