...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Первая программа в IntelliJ IDEA</h2><div class="date">Последнее обновление: 20.03.2024</div>
	<div class="socBlock">
	...
	<p>В прошлой теме мы рассмотрели, как создавать первую программу с последующим ее запуском в командной строке. Для упрощения разработки мы также можем 
использовать такие инструменты как IDE или интегрированные среды разработки, которые упрощают и ускоряют написание кода и создание приложений. На данный момент наиболее популярной средой разработки для Java является 
<b>IntelliJ IDEA</b> от компании JetBrains. Рассмотрим, как использовать данную среду.</p>
...
<p>Стоит отметить, Community-версия не имеет ряда многих 
возможностей, которые доступны в Ultimate-версии (в частности, в Community недоступны опции для 
...
<img src="./pics/intellijidea2.png" alt="Создание проекта в IntelliJ IDEA" style="width:650px;" />
<p>Далее откроется окно создания проекта. В левой части в качестве типа проекта выберем <span class="b">New Project</span>.</p>
<img src="./pics/intellijidea8.png" alt="Создание проекта Java в IntelliJ IDEA"  style="width:650px;" />
<p>В поле <span class="b">Name</span> укажем имя проекта. В моем случае проект будет называться HelloJava.</p>
<p>В поле <span class="b">Location</span> можно указать путь к проекту, если не устраивает путь по умолчанию.</p>
<p>Поскольку мы будем работать с языком Java, в поле <span class="b">Language</span> выберем пункт <span class="b">Java</span></p>
...
<img src="./pics/intellijidea9.png" alt="Первый проект на Java в IntelliJ IDEA"  style="width:650px;" />
<p>В левой части мы можем увидеть структуру проекта. Все файлы с исходным кодом помещаются в папку <span class="b">src</span>. 
По умолчанию эта папка пуста, никаких файлов кода у нас в проекте пока нет. Поэтому добавим файл с исходным кодом. Для этого нажмем на папку <span class="b">src</span> правой кнопкой мыши 
и в контекстном меню выберем пункт <span class="b">New -&gt; Java Class</span>:</p>
<img src="./pics/intellijidea10.png" alt="Добавления файла с кодом в проект на Java в IntelliJ IDEA"   style="width:700px;" />
<p>После этого нам откроется небольшое окошко, в которое надо ввести имя класса. Пусть класс будет называться <span class="b">Program</span>:</p>
<img src="./pics/intellijidea11.png" alt="Добавления класса в проект на Java в IntelliJ IDEA" style="width:550px;" />
<p>После нажатия на клавишу Enter в папку src будет добавлен новый файл с классом java (в случае выше класс Program). А в центральной части откроется его содержимое - собственно исходный код:</p>
<img src="./pics/intellijidea12.png" alt="Создание класса на Java в IntelliJ IDEA" style="width:700px;" />
<p>Изменим код класса следующим образом:</p>
...
<img src="./pics/intellijidea13.png" alt="запуск проекта на Java на выполнение в IntelliJ IDEA" style="width:700px;" />
<p>И внизу IntelliJ IDEA отобразится окно вывода, где мы можем увидеть результат работы нашей программы.</p>
<img src="./pics/intellijidea14.png" alt="Выполнение программы на Java в IntelliJ IDEA" style="width:700px;" />
...
<style>
	...
	<div class="nav"><p><a href="./1.2.php">Назад</a><a href="./">Содержание</a><a href="./1.3.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
