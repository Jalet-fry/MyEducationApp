...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Рекурсивные функции</h1><div class="date">Последнее обновление: 16.09.2025</div>
	<div class="socBlock">
...
В случае с факториалом это факториал числа 1, который равен 1. Факториалы всех остальных положительных чисел будет начинаться с вычисления факториала числа 1, который равен 1.</p>
<p>На уровне языка программирования для возвращения базового варианта применяется оператор <span class="b">return</span>:</p>
<pre class="brush:java;">if (n == 1) return 1;</pre>
...
<pre class="brush:java;">return 4 * factorial(3);</pre>
</li>

<li><p>Далее выполняется выражение:</p>
<pre class="brush:java;">factorial(3)</pre>
<p>Опять же <code>n</code> не равно 1, поэтому выполняется код</p>
<pre class="brush:java;">return n * factorial(n - 1);</pre>
<p>То есть фактически:</p>
<pre class="brush:java;">return 3 * factorial(2);</pre>
</li>

<li><p>Далее выполняется выражение:</p>
<pre class="brush:java;">factorial(2)</pre>
<p>Опять же <code>n</code> не равно 1, поэтому выполняется код</p>
<pre class="brush:java;">return n * factorial(n - 1);</pre>
<p>То есть фактически:</p>
<pre class="brush:java;">return 2 * factorial(1);</pre>
</li>

<li><p>Далее выполняется выражение:</p>
<pre class="brush:java;">factorial(1)</pre>
...
<pre class="brush:java;">factorial(4)</pre>
<p>В реальности выливается в</p>
<pre class="brush:java;">4 * 3 * 2 * factorial(1)</pre>
...
n-й член последовательности Фибоначчи определяется по формуле: fib(n)=fib(n-1) + fib(n-2), причем fib(0)=0, а fib(1)=1. То есть последовательность Фибоначчи 
...
результат выражения <code>fib(n - 1) + fib(n - 2);</code></p>
...
<style>
	...
	<div class="nav"><p><a href="./3.20.php">Назад</a><a href="./">Содержание</a><a href="./3.2.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
