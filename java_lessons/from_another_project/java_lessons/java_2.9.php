...
<meta charset="utf-8" />
<meta name="description" content="Вывод на консоль и ввод с консоли в языке программирования Java, метод System.out.println и объект System.in, класс Scanner, ввод дробных чисел">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Консольный ввод/вывод в Java</h1><div class="date">Последнее обновление: 16.09.2025</div>
	<div class="socBlock">
...
<li><p><span class="b">%b</span>: для вывода значений типа <code>boolean</code></p></li>
</ul>
<p>Например:</p>
<pre class="brush:java;">
class Program {
...
<style>
	...
	<div class="nav"><p><a href="./2.12.php">Назад</a><a href="./">Содержание</a><a href="./2.3.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
