...
<h3>distinct</h3>
<p>Метод <span class="b">distinct()</span> возвращает только уникальные элементы в виде потока:</p>
<pre class="brush:java;">
...
<style>
	...
	<div class="nav"><p><a href="./10.8.php">Назад</a><a href="./">Содержание</a><a href="./10.4.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
