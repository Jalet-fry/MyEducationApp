...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Перегрузка методов</h1><div class="date">Последнее обновление: 16.09.2025</div>
	<div class="socBlock">
...
<p>Здесь определен класс Calculator с тремя вариантами или тремя перегрузками метода <code>sum()</code>, но при его вызове в зависимости от типа и количества передаваемых 
...
Например, в следующем случае методы sum различаются по типу возвращаемого значения:</p>
<pre class="brush:java;">
class Program{
...
<style>
	...
	<div class="nav"><p><a href="./2.17.php">Назад</a><a href="./">Содержание</a><a href="./3.21.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
