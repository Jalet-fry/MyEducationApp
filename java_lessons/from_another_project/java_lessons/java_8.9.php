...
<meta charset="utf-8" />
<meta name="description" content="Блокировки. ReentrantLock в многопоточных приложениях на языке программирования Java, пакет java.util.concurrent.locks">
...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Блокировки. ReentrantLock</h1><div class="date">Последнее обновление: 22.10.2025</div>
	<div class="socBlock">
...
<p>После этого только один поток имеет доступ к критической секции, которую образыет блок <code>try</code>, а остальные потоки ожидают снятия блокировки. В блоке <code>finally</code> после всей 
окончания основной работы потока эта блокировка снимается.</p>
<pre class="brush:java;">
finally{
    locker.unlock(); // снимаем блокировку
}
</pre>
<p>Причем делается это обязательно в блоке <code>finally</code>, так как в случае 
возникновения ошибки все остальные потоки окажутся заблокированными.</p>
<p>В итоге мы получим консольный вывод, аналогичный следующему:</p>
<pre class="sh">
Thread 4 1 
Thread 4 2 
Thread 4 3 
...
<style>
	...
	<div class="nav"><p><a href="./8.8.php">Назад</a><a href="./">Содержание</a><a href="./8.10.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
