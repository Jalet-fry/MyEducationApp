...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Типы данных</h1><div class="date">Последнее обновление: 16.09.2025</div>
	<div class="socBlock">
...
<li><p><span class="b">double</span>: хранит число с плавающей точкой от <code>±4.9*10<sup>-324</sup></code> до <code>±1.7976931348623157*10<sup>308</sup></code> и 
...
<p>Стоит отметить, что текстовые блоки в тройных кавычках также рассматриваются как данные типа <code>String</code>, которые удобно использовать для установки многострочного текста:</p>
<pre class="brush:java;">
String text = """
...
<style>
	...
	<div class="nav"><p><a href="./2.19.php">Назад</a><a href="./">Содержание</a><a href="./2.9.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
