...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Циклы</h2><div class="date">Последнее обновление: 16.09.2025</div>
	<div class="socBlock">
...
<p>Циклы могут быть вложенными. Например:</p>
<pre class="brush:java;">
class Program{
...
<p>Здесь у нас есть внешний цикл (цикл <code>for (int i = 1; i &lt;= 9; i++) </code>), который управляет количеством строк. Он начинается с i = 1 и продолжается, пока i не достигнет значения 9.</p>
<p>На каждой итерации внешнего цикла мы выводим одну строку. Внутри внешнего цикла у нас есть другой цикл (цикл <code>for (int j = 1; j &lt;= 9; j++)</code>). 
Он начинается с j = 1 и продолжается, пока j не достигнет значения 9. На каждой итерации внутреннего цикла мы выводим звёздочку произведение <code>i * j</code> и табуляцию для отступа. 
После завершения внутреннего цикла мы переходим к следующей строке (<code>System.out.println()</code>), чтобы начать новую строку. В результате вложенных циклов мы получим некое подобие таблицы умножения.</p>
<h3>Цикл do</h3>
...
</fieldset></div>	<div class="nav"><p><a href="./2.5.php">Назад</a><a href="./">Содержание</a><a href="./2.4.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
