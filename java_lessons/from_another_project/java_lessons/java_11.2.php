...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Зависимые модули</h1><div class="date">Последнее обновление: 02.11.2025</div>
	<div class="socBlock">
...
<p>В данном случае модуль назвается "demo" и располагается в одноименной папке. В этой же папке лежит файл определения модуля - <span class="b">module-info.java</span>. А весь код программы располагается в папке "com/metanit/hello" в файле "Hello.java".</p>
...
java.desktop. Для этого перейдем к определению модуля в файле <span class="b">module-info.java</span> в корневой папке модуля и изменим его следующим образом:</p>
<pre class="brush:java;">
module demo {
...
<p>Далее скомпилируем модуль и запустим его на выполнение.</p>
<pre class="sh">
...
<p>После запуска нам отобразится графическое окно:</p>
...
<style>
	...
	<div class="nav"><p><a href="./11.1.php">Назад</a><a href="./">Содержание</a><a href="./11.3.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
