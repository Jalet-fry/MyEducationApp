...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Типы коллекций. Интерфейс Collection</h1><div class="date">Последнее обновление: 11.10.2025</div>
	<div class="socBlock">
...
Эту проблему в Java решают функционал коллекций в виде <b>Java Collections Framework</b> - подсистема по работе с коллекциями. Однако суть не только в гибких по размеру наборах объектов, но в и том, что классы коллекций реализуют различные алгоритмы 
и структуры данных, например, такие как стек, очередь, дерево и ряд других.</p> 
<p>Типы коллекций располагаются в пакете <b>java.util</b>, поэтому перед применением коллекций следует подключить данный пакет.</p>
<p>Хотя в Java существует множество коллекций, но все они образуют стройную и логичную систему. Во-первых, <code>Java Collections Framework</code> отделяет интерфейс/определение от реализации. 
В основе всех коллекций лежит тот или иной интерфейс, который определяет базовый функционал. Среди этих интерфейсов можно выделить следующие:</p>
<ul>
...
<img src="./pics/5.3.png" alt="Интерфейсы коллекций в Java Collections Framework" />
...
<li><p><code>boolean containsAll (Collection&lt;?&gt; col)</code>: возвращает true, если коллекция содержит все элементы из коллекции col, иначе возвращает false</p></li>
...
<li><p><code>boolean removeIf (Predicate&lt;? super E&gt; filter)</code>: удаляет все элементы коллекции, если они соответствуют предикату filter.</p></li>
...
<style>
	...
	<div class="nav"><p><a href="./4.4.php">Назад</a><a href="./">Содержание</a><a href="./5.2.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
