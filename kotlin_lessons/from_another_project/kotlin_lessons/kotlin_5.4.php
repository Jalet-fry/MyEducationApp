...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Инфиксная нотация</h2><div class="date">Последнее обновление: 02.03.2024</div>
	<div class="socBlock">
...
<pre class="brush:kt;">tom says "Hello"</pre>
...
<style>
	...
	<div class="nav"><p><a href="./5.7.php">Назад</a><a href="./">Содержание</a><a href="./7.1.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
