...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Основы языка Kotlin</h1><h2>Структура программы</h2><div class="date">Последнее обновление: 02.03.2024</div>
	<div class="socBlock">
...
<p>Параметр <code>args: Array&lt;String&gt;</code> представляет массив строк, через который в программу можно передать различные данные.</p>
...
(в данном случае строку "Hello METANIT.COM!").</p>
...
<style>
	...
	<div class="nav"><p><a href="./1.2.php">Назад</a><a href="./">Содержание</a><a href="./2.1.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
