...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Переменное количество параметров. Vararg</h2><div class="date">Последнее обновление: 02.03.2024</div>
	<div class="socBlock">
...
<p>Если функция принимает несколько параметров, то обычно <span class="b">vararg</span>-параметр является последним.</p>
<pre class="brush:kt;">
...
<p>Однако это необязательно, но если после <span class="b">vararg</span>-параметра идут еще какие-нибудь параметры, то при вызове функции значения этим 
...
<p>Здесь функция printUserGroup принимает три параметра. Значения параметрам до <span class="b">vararg</span>-параметра передаются по позициям. То есть в данном случае 
"KT-091" будет представлять значение для параметра group. Последующие значения интерпретируются как значения для <span class="b">vararg</span>-параметра вплоть до именнованных аргументов.</p>
<h3>Оператор *</h3>
