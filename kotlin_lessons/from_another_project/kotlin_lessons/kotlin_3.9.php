...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Тип функции</h2><div class="date">Последнее обновление: 03.03.2024</div>
	<div class="socBlock">
...
<p>Если функция не принимает параметров, в определении типа указываются пустые скобки. Если не указан возвращаемый тип, то фактически а в качестве типа возвращаемого значения 
применяется тип <code>Unit</code>.<p>
...
<style>
	...
	<div class="nav"><p><a href="./3.5.php">Назад</a><a href="./">Содержание</a><a href="./3.7.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
