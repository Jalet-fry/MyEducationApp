...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h1>Корутины</h1><h2>Введение в корутины</h2><div class="date">Последнее обновление: 11.12.2024</div>
	<div class="socBlock">
...
<style>
	...
	<div class="nav"><p><a href="./7.15.php">Назад</a><a href="./">Содержание</a><a href="./8.2.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
