...
<div class="innercontainer">
   ...
   <div class="item center menC">
     <h2>Вариантность, ковариантность и контравариантность</h2><div class="date">Последнее обновление: 04.03.2024</div>
	<div class="socBlock">
...
<p>В данном случае интерфейс Messenger является <span class="b">ковариантным</span>, так как его параметр определен со словом <span class="b">out</span>:</p>
<pre class="brush:kt;">interface Messenger&lt;out T&gt;</pre>
<p>И теперь переменной типа <code>Messenger&lt;Message&gt;</code> мы можем присвоить значение типа <code>Messenger&lt;EmailMessage&gt;</code></p> 
<pre class="brush:kt;">
fun changeMessengerToEmail(obj: Messenger&lt;EmailMessage&gt;){
    val messenger: Messenger&lt;Message&gt; = obj
}
...
<p>В данном случае интерфейс Messenger является <span class="b">контравариантным</span>, так как его параметр определен со словом <span class="b">in</span>:</p>
<pre class="brush:kt;">interface Messenger&lt;in T&gt;</pre> 
<p>И теперь переменной типа <code>Messenger&lt;EmailMessage&gt;</code> мы можем присвоить значение типа <code>Messenger&lt;Message&gt;</code></p> 
<pre class="brush:kt;">
fun changeMessengerToDefault(obj: Messenger&lt;Message&gt;){
    val messenger: Messenger&lt;EmailMessage&gt; = obj
}
...
<style>
	...
	<div class="nav"><p><a href="./6.2.php">Назад</a><a href="./">Содержание</a><a href="./5.2.php">Вперед</a></p></div>
	<div class="socBlock">
	<div class="share soctop">
	<ul>
	<li><a title="Поделиться в Вконтакте" rel="nofollow" class="fa fa-lg fa-vk"></a></li>
